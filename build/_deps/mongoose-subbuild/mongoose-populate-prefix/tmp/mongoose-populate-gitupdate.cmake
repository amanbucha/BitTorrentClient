...
execute_process(
  COMMAND "/usr/bin/git" show-ref "6.18"
  WORKING_DIRECTORY "/home/aman/yo/BitTorrentClient/build/_deps/mongoose-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("6.18" tag_sha error_msg)
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/aman/yo/BitTorrentClient/build/_deps/mongoose-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/aman/yo/BitTorrentClient/build/_deps/mongoose-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
